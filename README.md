# Task Manager - Power Platform Solution
...
[![Watch the tutorial on YouTube](https://img.youtube.com/vi/vjhaJB9RBQ8/maxresdefault.jpg)](https://youtu.be/vjhaJB9RBQ8)
...
2. Download the `TaskManager_1_0_0_1.zip` file from the latest release
...
2. Select all files and folders **inside** the folder (not the folder itself):
   ...
   - `solution.xml`
   - `CanvasApps/`
3. Compress them into a `.zip` file (e.g. `TaskManager_1_0_0_1.zip`)
